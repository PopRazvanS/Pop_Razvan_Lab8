...
namespace Pop_Razvan_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Pop_Razvan_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Pop_Razvan_Lab8Context context,
